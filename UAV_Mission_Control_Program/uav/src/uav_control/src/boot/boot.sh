...
PATH_TO_BOOT=/home/yifan/git/uav-control-mavros/src/uav_control/src/boot
PATH_TO_UAVPKG=/home/yifan/git/uav-control-mavros
PORT_VERIFIER=/home/yifan/git/uav-control-mavros/devel/lib/uav_control/verify_port_assignment
BOOT_LOG=~/.uav_control_boot_log
MOM_BYPASS="yes"  # yes/no : whether the PixHawk of UAV mom is connected to the system or not
...
# starting necessary ROS nodes
  ...
  then
    screen -d -m -S $SCREEN_NODE ${PATH_TO_BOOT}/mom_node_autostart.sh $PATH_TO_UAVPKG $SERIAL_PORT_TCH1 $SERIAL_PORT_TCH2
    sleep 2
